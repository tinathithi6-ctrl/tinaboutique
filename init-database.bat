...
echo ==========================================================
echo.
echo Ce script va creer toutes les tables necessaires pour:
...
echo.
echo IMPORTANT: Assurez-vous que PostgreSQL est demarre !
echo.
pause
...
echo ^);
echo.
echo -- Ajouter colonnes multi-devises a orders
echo DO $$ 
echo BEGIN
...
echo END $$;
echo.
echo -- Ajouter colonne preferred_currency a users
echo DO $$ 
echo BEGIN
...
echo    [OK] currency_rates (taux de change)
...
echo    3. Verifier le nouveau dashboard et logs
echo.
